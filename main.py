...
@torch.no_grad
def get_batch(data_dict, key, batchsize, length, model: SpeedyLangNet | None = None):
...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="The size difference between the two models. "
        "TYPE: float; DEFAULT: 10.0"
    )
    parser.add_argument(
        "--large_model_loss",
...
def main():
    ...
    total_num_runs = int(len(settings) * args.num_runs * 3)
